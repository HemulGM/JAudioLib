...
uses
  Winapi.Windows, Winapi.ActiveX, Winapi.PropSys, Jal.Win.EndpointVolume,
  Jal.Win.AudioClient;
...
type
 {$SCOPEDENUMS ON}
 {$MINENUMSIZE 4}
  TDataFlow = (Render = $00000000, Capture = $00000001, All = $00000002, Last = $00000003);

  TRole = (Console = $00000000, Multimedia = $00000001, Communications = $00000002, Last = $00000003);
 {$MINENUMSIZE 1}
  ...
  IMMDevice = interface(IUnknown)
    ...
    function Activate(const IID: TGUID; ClsCtx: DWORD; ActivationParams: PPropVariant; out Intf): HRESULT; stdcall;
    function OpenPropertyStore(Access: DWORD; out Properties: IPropertyStore): HRESULT; stdcall;
    function GetId(out Id: PWideChar): HRESULT; stdcall;
    function GetState(out State: DWORD): HRESULT; stdcall;
  end;

  IMMDeviceCollection = interface(IUnknown)
    ['{0BD7A1BE-7A1A-44DB-8397-CC5392387B5E}']
    function GetCount(Devices: PDWORD): HRESULT; stdcall;
    function Item(NumDevice: DWORD; out Device: IMMDevice): HRESULT; stdcall;
  end;
  ...
  IMMDeviceEnumerator = interface(IUnknown)
    ...
    function EnumAudioEndpoints(DataFlow: TDataFlow; StateMask: DWORD; out Devices: IMMDeviceCollection): HRESULT; stdcall;
    function GetDefaultAudioEndpoint(DataFlow: TDataFlow; Role: TRole; out Endpoint: IMMDevice): HRESULT; stdcall;
    function GetDevice(Id: PWideChar; out Device: IMMDevice): HRESULT; stdcall;
    function RegisterEndpointNotificationCallback(Client: IMMNotificationClient): HRESULT; stdcall;
    function UnregisterEndpointNotificationCallback(Client: IMMNotificationClient): HRESULT; stdcall;
  end;
